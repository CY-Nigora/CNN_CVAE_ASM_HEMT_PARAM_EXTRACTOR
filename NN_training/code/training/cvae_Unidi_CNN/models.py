...
class CoordinateHybridEncoder(nn.Module):
    ...
    """
    def __init__(self, iv_shape=(7, 121), gm_shape=(10, 71), feat_dim=256, dropout=0.0, use_stats=False):
        super().__init__()
        ...
        self.iv_grid = (3, 12)  # IV保留更多水平细节 (121 -> 12)
        self.gm_grid = (3, 6)   # Gm相对较短 (71 -> 6)
...
class DualCurveMLPEncoder(nn.Module):
    ...
    """
    def __init__(self, iv_shape=(7, 121), gm_shape=(10, 71), feat_dim=256, dropout=0.0):
        super().__init__()
